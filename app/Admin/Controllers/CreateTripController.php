...
class CreateTripController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $vehicles = VehicleCategory::where('country_id',DB::table('app_settings')->where('id',1)->value('default_country'))->where('vehicle_mode',18)->pluck('vehicle_type', 'id');
    ...
    public function update_dispatch_booking($input){
        ...
        $country_id = DB::table('app_settings')->where('id',1)->value('default_country');
        ...
        $current_date = $this->get_date($country_id);
